...
\begin{titlepage}
    ...
    \begin{tabular}{|p{2.8cm}|p{6.5cm}|p{3cm}|p{2.5cm}|}
        ...
        D1-\ProjectTitle-DescrizioneProgetto & 
        \cellcolor{WattOrange!60}\textbf{Doc. Number} & 
        D1 V1.0 \\
        \hline
        \cellcolor{WattOrange!60}\textbf{Description} & 
        \multicolumn{3}{l|}{Documento di analisi del progetto} \\
        \hline
    \end{tabular}
    \endgroup
...
\include{chapter/slidePitch}
\include{chapter/requisitiFunzionali}
\include{chapter/requisitiNonFunzionali}
\include{chapter/useCase}
\include{chapter/userStory}
\include{chapter/designFrontend}
\include{chapter/userWorkflow}
