...
interface BuildingFormContextValue {
  geocoding: boolean
...
function useBuildingFormContext() {
...
interface BuildingFormRootProps {
...
export function BuildingFormRoot({
  ...
  return (
    <Form {...form}>
      <BuildingFormContext
        value={{ geocoding, mapCenter, markerPosition, handleGeocode, handleMapClick, isPending }}
      >
